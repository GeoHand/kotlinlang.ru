...
Некоторые API инициируют долго протекающие операции (такие как сетевой ввод-вывод, файловый ввод-вывод, интенсивная обработка на CPU или GPU и др.) и требуют блокироки вызывающего потока выполнения в ожидании завершения операций. Механизм сопрограмм  позволяет избежать блокировки потока выполнения и заменить его на более дешевый и более комфортный: зависание (suspension) сопрограммы.
